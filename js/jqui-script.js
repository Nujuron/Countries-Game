 ...
 * @param {Minimun number } min 
 * @param {Maximun number} max 
 */
 ...
 * @param {Node to delete} parentNode 
 */
 ...
 * @param {min of the random number} min 
 * @param {max of the random number} max 
 * @param {number of countries in a match} numberCountries 
 */
 ...
 * @param {Element to check} droppables 
 */
